...
//        public List<PriceHistory> PriceHistories { get; set; } //mojet nazvat prosto Price
...
//        public double FuelConsumptionAverage { get; set; } //100 kilometre yediyi benzin
//        public double FuelConsumptionCity { get; set; } //100 kilometre yediyi benzin
//        public double FuelConsumptionHighway { get; set; } //100 kilometre yediyi benzin
...
//        public int TransmissionType { get; set; } // korobka peredach // na moto avto/mexanik/yari avtomat
//        public int TransportType { get; set; } // avto, moto, bus, itd 
//        public int BodyType { get; set; } //sedan kupe kabrio zad
//        public int HeadlightType { get; set; } //xenon, biksenon, lazer, diod, lampa(takoy est?) - sozdat etot enum, proverit druqie!
...
//        //mi pramo na stranicke dobavleniya budem govorit useru vistavit vip, premium, ili sade. vne zavisimosti ot togo shto on viberet, mi vse ravno sozdadim elan. no, esli on ne oplatit, vip/premium olmayacag, tipa bank sehifesinnen obratno qayidsa

//        //esli mashina privoznaya, ukazivat eto vse nado useru dla ego je polzi
//        //mashinin udush qiymeti
//        //auksionniy sbor
//        //dashinma xerci do porta v amerike
//        //dashinma xerci po moryu
//        //terminal haqqi
//        //potiden bakiya dashinma
//        //saticinin xidmet haqqi
...
//        //moto props
//        public int EngineType { get; set; } //2 taktli ve ya 4 taktli
//        public int FuelSystem { get; set; } //injector ili karburator
//    }
//}
