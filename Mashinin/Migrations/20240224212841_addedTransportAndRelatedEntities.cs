        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceForRepair = table.Column<double>(type: "float", nullable: false),
                    FuelConsumptionAverage = table.Column<double>(type: "float", nullable: false),
                    ...
                    ExporterCountry = table.Column<int>(type: "int", nullable: false),
                    TransmissionType = table.Column<int>(type: "int", nullable: false),
                    TransportType = table.Column<int>(type: "int", nullable: false),
                    BodyType = table.Column<int>(type: "int", nullable: false),
                    HeadlightType = table.Column<int>(type: "int", nullable: false),
                    FuelSystem = table.Column<int>(type: "int", nullable: false),
                    EngineType = table.Column<int>(type: "int", nullable: false),
                    WinPriceMin = table.Column<double>(type: "float", nullable: false),
                    WinPriceMax = table.Column<double>(type: "float", nullable: false),
                    AuctionPayables = table.Column<double>(type: "float", nullable: false),
                    TransportationPriceToPort = table.Column<double>(type: "float", nullable: false),
                    TransportationPriceBySea = table.Column<double>(type: "float", nullable: false),
                    TerminalPayables = table.Column<double>(type: "float", nullable: false),
                    TransportationPriceToBaku = table.Column<double>(type: "float", nullable: false),
                    ProfitOfSeller = table.Column<double>(type: "float", nullable: false),
                    ...
                    IsFromSaloon = table.Column<bool>(type: "bit", nullable: false),
                    IsFromPerson = table.Column<bool>(type: "bit", nullable: false),
